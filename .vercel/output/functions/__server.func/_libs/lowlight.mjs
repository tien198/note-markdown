import "./devlop.mjs";
import { arduino, bash, c, core_default, cpp, csharp, css, diff, go, graphql, ini, java, javascript, json, kotlin, less, lua, makefile, markdown, objectivec, perl, php, phpTemplate, plaintext, python, pythonRepl, r, ruby, rust, scss, shell, sql, swift, typescript, vbnet, wasm, xml, yaml } from "./highlight.js.mjs";
...
//#endregion
export { createLowlight, grammars };
