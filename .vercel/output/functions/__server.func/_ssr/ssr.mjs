...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D56lo3f1.mjs");
...
var manifest = { "839c02c1997c2eb923b5fd2d0ed6e38e33a0c8effd5394aa55663aa883500c78": {
	functionName: "getMarkdownContent_createServerFn_handler",
	importer: () => import("../_slug-CM9XArLb.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CezMUvCR.mjs").then((n) => n.router_exports),
...
//#endregion
export { TSS_SERVER_FUNCTION, createServerFn, getServerFnById, ssr_exports };
